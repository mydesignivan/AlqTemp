                ...
                <div class="content_left">
                 ...
                 ?>
                    ...
                    <form name="formAccount" id="formAccount" action="<?=site_url('/registro/create');?>" method="post" enctype="application/x-www-form-urlencoded">
                        <p><span class="cell">*Nombre:</span><input type="text" name="txtName" class="input style_input validate {v_required:true}" value="<?=$data['name'];?>" /></p>
                        <p><span class="cell">*E-Mail:</span><input type="text" name="txtEmail" class="input style_input validate {v_email:true}" value="<?=$data['email'];?>" /></p>
                        <p><span class="cell">Teléfono:</span><input type="text" name="txtPhone" class="input style_input" value="<?=$data['phone'];?>" /></p>
                        <p><span class="cell">*Usuario:</span><input type="text" name="txtUser" class="input style_input validate {v_required:true}" value="<?=$data['username'];?>" /></p>
                        <p><span class="cell">*Contraseña:</span><input type="password" name="txtPass" id="txtPass" class="input style_input validate {v_password:[6,10], v_required:true}" value="" /></p>
