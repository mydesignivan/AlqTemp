...
<?php }else{?>
            ...
            <form id="formProp" action="" method="post" enctype="application/x-www-form-urlencoded">
               ...
               ?>
                ...
                <div class="clear span-9 prepend-top-small">
            ...
            <?php }?>
                ...
                <div class="clear span-6 prepend-top-small">
                    ...
                    <div class="float-right">
                        <select id="cboCapacity" name="cboCapacity" onchange="Prop.actions.capacity_change(this.value);">
                            <?php for($n=0; $n<=9; $n++) {
