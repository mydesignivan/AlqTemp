    ...
    <div id="container">
      ...
      <div class="container_mainContent">
            <div id="mainContent">
                ...
                <div class="selection">
                	<div class="selection_left">Destacarme en <span>la p&aacute;gina de Inicio: </span>
                	  <br /><form action="" enctype="application/x-www-form-urlencoded">
                ...
                <div class="container_button"><a href="#" class="button2">Canjear Puntos</a>
                </div>
                <br />&nbsp;<br />
                <div class="selection"><h2>Propiedades que ya han sido destacadas</h2>
